...
import kotlinx.android.synthetic.main.chat_message_me_item.view.*
import java.text.SimpleDateFormat
import java.util.*

class ChatMessageMeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    companion object {
        fun newInstance(parent: ViewGroup): ChatMessageMeViewHolder {
            val view = LayoutInflater
                .from(parent.context)
                .inflate(R.layout.chat_message_me_item, parent, false)
            return ChatMessageMeViewHolder(view)
        }
    }
}
